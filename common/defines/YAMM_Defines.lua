...
NDefines.NCountry.POPULATION_YEARLY_GROWTH_BASE = 0.075
...
NDefines.NMilitary.LAND_COMBAT_COLLATERAL_FACTOR = 0.0020
...
NDefines.NAir.LEND_LEASED_EQUIPMENT_EXPERIENCE_GAIN = 0.5
...
NDefines.NNavy.DETECTION_CHANCE_MULT_BASE = 0.02
...
NDefines.NNavy.COMBAT_DETECTED_CONVOYS_FROM_SURFACE_DETECTION_STAT = 0.15
